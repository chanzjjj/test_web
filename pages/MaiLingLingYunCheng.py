...
class Mailinglingyuncheng(Base):
    '''定义所需要的元素'''
    ele_name = ("xpath",'//*[@id="root"]/div[3]/div[2]/section/div/ul/li[1]/div[2]/input')  # 姓名输入框
    ele_birthday = ("xpath", '//*[@id="root"]/div[3]/div[2]/section/div/ul/li[3]/div[2]/input')  # 出生日期输入框
    ele_ljcs = ("xpath",'//*[@id="root"]/div[3]/div[2]/div/div')  # 立即测算按钮
